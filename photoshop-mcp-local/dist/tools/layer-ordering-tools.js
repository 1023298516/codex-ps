...
export function createLayerOrderingTools(connection) {
    return [
        {
            tool: {
...
async function moveLayerToPosition(connection, args) {
    const targetLayerName = args.targetLayerName;
...
async function moveLayerToTop(connection) {
    try {
        const apiFactory = new PhotoshopAPIFactory(connection);
        const api = await apiFactory.createAPI();
...
async function moveLayerToBottom(connection) {
    try {
        const apiFactory = new PhotoshopAPIFactory(connection);
        const api = await apiFactory.createAPI();
...
async function moveLayerUp(connection) {
    try {
        const apiFactory = new PhotoshopAPIFactory(connection);
        const api = await apiFactory.createAPI();
...
async function moveLayerDown(connection) {
    try {
        const apiFactory = new PhotoshopAPIFactory(connection);
        const api = await apiFactory.createAPI();
...
//# sourceMappingURL=layer-ordering-tools.js.map