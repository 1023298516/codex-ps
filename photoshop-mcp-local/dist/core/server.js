...
import { createOpenAIImageTools } from '../tools/openai-image-tools.js';
import { createCodexImageTools } from '../tools/codex-image-tools.js';
export class PhotoshopMCPServer {
    ...
    registerTools() {
        ...
        const openAIImageTools = createOpenAIImageTools(connection);
        openAIImageTools.forEach((tool) => {
            this.toolRegistry.register(tool.tool.name, tool);
        });
        const codexImageTools = createCodexImageTools(connection);
        codexImageTools.forEach((tool) => {
            this.toolRegistry.register(tool.tool.name, tool);
        });
